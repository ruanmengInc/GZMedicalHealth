...
//                             };
//    
//    [YYHttpTool JIanshangpostRequestUrlStrIsHeader:NO  url:@"/index/getStoreCity"  WithDic:params success:^(NSDictionary *requestDic, NSString *msg) {
//        
////        self.characterMutableArray = [NSKeyedUnarchiver unarchiveObjectWithData:[kCurrentCityInfoDefaults objectForKey:@"cityData"]];
////        _sectionMutableArray = [NSKeyedUnarchiver unarchiveObjectWithData:[kCurrentCityInfoDefaults objectForKey:@"sectionData"]];
//        
//        _sectionMutableArray = [NSMutableArray arrayWithArray:@[@{@"cityname":@"郑州"},@{@"cityname":@"郑州"},@{@"cityname":@"郑州"},@{@"cityname":@"开封"},@{@"cityname":@"哎州"},@{@"cityname":@"郑州"},@{@"cityname":@"郑州"},@{@"cityname":@"郑州"},@{@"cityname":@"才州"},@{@"cityname":@"郑州"},@{@"cityname":@"郑州"},@{@"cityname":@"郑州"}]];
//        
//        // 转化为索引数组
//        NSMutableArray *initialArray = [NSMutableArray new];
//        NSMutableArray *afterSortArray = [NSMutableArray array];
//        NSMutableArray *finialSortArray = [NSMutableArray array];
//
//        for (int i=0; i<_sectionMutableArray.count; i++) {
//            
//            [initialArray addObject:[NSString firstCharactorWithString:_sectionMutableArray[i][@"cityname"]]];
//        }
//        
//        /// 删除首字母数组中相同的元素
//        [afterSortArray addObjectsFromArray: [GZTool removesTheSameElementsInTheArray:initialArray]];
//
//
//        /// 首字母数组从 A - Z 排序
//        finialSortArray = (NSMutableArray *)[afterSortArray sortedArrayUsingSelector:@selector(compare:)];
//        
//        [self.characterMutableArray addObjectsFromArray:finialSortArray];
//        
//        [_rootTableView reloadData];
//        
...
- (void)backBarButtonItem {
    ...
    leftButton.GZ_left = -20;
    leftButton.GZ_width = 30;
    leftButton.GZ_height = kTopHeight;
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    NSArray *arr = _sectionMutableArray[0][_characterMutableArray[section]];
