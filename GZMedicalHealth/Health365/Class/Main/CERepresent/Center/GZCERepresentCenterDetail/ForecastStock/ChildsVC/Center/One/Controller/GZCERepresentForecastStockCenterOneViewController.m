//
//  GZCERepresentForecastStockCenterOneViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentForecastStockCenterOneViewController ()

@end

@implementation GZCERepresentForecastStockCenterOneViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:[GZCERepresentForecastStockCenterTwoViewController new] animated:YES];
}
