//
//  GZCERepresentForecastStockCenterViewController.m
//  GZMedicalHealth
//
...
#import "GZCERepresentForecastStockCenterOneViewController.h"
#import "CMHExampleTableTestCell.h"
#import "CMHExampleTableTest.h"

@interface GZCERepresentForecastStockCenterViewController ()

@end

@implementation GZCERepresentForecastStockCenterViewController
...
-(void)viewDidLayoutSubviews
{
    ...
    self.tableView.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight - self.topHeight - kTopHeight);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:[GZCERepresentForecastStockCenterOneViewController new] animated:YES];
}
