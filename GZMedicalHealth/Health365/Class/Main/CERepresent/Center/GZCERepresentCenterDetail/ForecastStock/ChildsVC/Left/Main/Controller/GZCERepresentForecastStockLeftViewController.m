//
//  GZCERepresentForecastStockLeftViewController.m
//  GZMedicalHealth
//
...
#import "GZCERepresentForecastStockLeftOneViewController.h"
#import "CMHExampleTableTestCell.h"
#import "CMHExampleTableTest.h"

@interface GZCERepresentForecastStockLeftViewController ()

@end

@implementation GZCERepresentForecastStockLeftViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:[GZCERepresentForecastStockLeftOneViewController new] animated:YES];
}
