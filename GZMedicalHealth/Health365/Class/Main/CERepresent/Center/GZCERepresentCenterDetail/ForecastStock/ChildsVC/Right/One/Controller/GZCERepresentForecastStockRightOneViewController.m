//
//  GZCERepresentForecastStockRightOneViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentForecastStockRightOneViewController ()

@end

@implementation GZCERepresentForecastStockRightOneViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:[GZCERepresentForecastStockRightTwoViewController new] animated:YES];
}
