//
//  GZCERepresentForecastStockLeftOneViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentForecastStockLeftOneViewController ()

@end

@implementation GZCERepresentForecastStockLeftOneViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:[GZCERepresentForecastStockLeftTwoViewController new] animated:YES];
}
