...
-(void)CreatUI{
    ...
    qxbtn=[UIButton new];
    qxbtn.backgroundColor=[UIColor colorWithHexString:@"#ffffff"];
    ...
    [qxbtn setTitleColor:[UIColor colorWithHexString:@"#3a3a3a"] forState:UIControlStateNormal];
    [alertView addSubview:qxbtn];
    
    okbtn=[UIButton new];
    [okbtn addTarget:self action:@selector(okTap) forControlEvents:UIControlEventTouchUpInside];
    okbtn.backgroundColor=[UIColor colorWithHexString:@"#ffffff"];
    [okbtn setTitle:@"确定" forState:UIControlStateNormal];
    [okbtn setTitleColor:[UIColor colorWithHexString:@"#3a3a3a"] forState:UIControlStateNormal];
