//
//  GZCERepresentMineViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentMineViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GZCERepresentMineViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.mineIndexPath = indexPath;
    cell.dict = self.dataArray[indexPath.row];
    cell.mineModel = self.headerView.model;
...
{    
    switch (indexPath.row) {
        ...
        case 2:
        {
            ...
            [self.navigationController pushViewController:[GZCEManagerMyHuiYuanViewController new] animated:YES];
        }
            break;
...
-(GZCERepresentMineHeaderView *)headerView
{
    if (_headerView == nil) {
        ...
        _headerView.frame = CGRectMake(0, -20, kScreenWidth, 227);
