//
//  GZCERepresentConferencePushViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentConferencePushViewController ()

@end

@implementation GZCERepresentConferencePushViewController
