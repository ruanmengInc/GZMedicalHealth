//
//  GZCERepresentMyPointsLeftViewController.m
//  GZMedicalHealth
//
...
@interface GZCERepresentMyPointsLeftViewController ()<UIScrollViewDelegate>
...
@implementation GZCERepresentMyPointsLeftViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    GZCERepresentMyPointsLeftTwoViewController *temp = [[GZCERepresentMyPointsLeftTwoViewController alloc] initWithParams:nil];
