//
//  GZManagerMonthlyAchievementRightViewTwoController.m
//  GZMedicalHealth
//
...
@interface GZManagerMonthlyAchievementRightViewTwoController ()

@end

@implementation GZManagerMonthlyAchievementRightViewTwoController
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    self.headerView.huiYuanLab.text = [NSString stringWithFormat:@"%@可用积分",self.name];
...
- (void)tableViewDidTriggerHeaderRefresh{
    ...
    subscript[@"action"] = @"user_365_hyjifen";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.type = [NSString stringWithFormat:@"%ld",self.pageIndex + 1];
    
    cell.weisaoDic = self.dataSource[indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GZManagerAchievementsDayViewTwoController *temp = [[GZManagerAchievementsDayViewTwoController alloc] initWithParams:nil];
