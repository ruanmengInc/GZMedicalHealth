...
@property (nonatomic, assign) CGPoint GZ_origin;
@property (nonatomic, assign) CGSize GZ_size;

// shortcuts for positions
@property (nonatomic) CGFloat GZ_centerX;
@property (nonatomic) CGFloat GZ_centerY;


@property (nonatomic) CGFloat GZ_top;
@property (nonatomic) CGFloat GZ_bottom;
@property (nonatomic) CGFloat GZ_right;
@property (nonatomic) CGFloat GZ_left;

@property (nonatomic) CGFloat GZ_width;
@property (nonatomic) CGFloat GZ_height;
