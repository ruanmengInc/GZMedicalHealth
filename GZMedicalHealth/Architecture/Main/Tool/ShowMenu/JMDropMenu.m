...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([_delegate respondsToSelector:@selector(didSelectRowAtIndex:Title:Image:tag:)]) {
        [_delegate didSelectRowAtIndex:indexPath.row Title:model.title Image:model.image tag:self.tag];
    }
    [self removeDropMenu];
}
