...
- (void)tableViewDidTriggerHeaderRefresh{
    ...
    /// 3. 发起请求
    [[CMHHTTPRequest requestWithParameters:paramters] enqueueResultClass:CMHLiveRoom.class parsedResult:YES isRequestHead:NO isShowHudMsg:YES success:^(NSURLSessionDataTask *task, NSArray <CMHLiveRoom *> * responseObject) {
...
- (void)tableViewDidTriggerFooterRefresh{
    ...
    /// 2. 配置参数模型 #define CMH_GET_LIVE_ROOM_LIST  @"Room/GetHotLive_v2"
    CMHURLParameters *paramters = [CMHURLParameters urlParametersWithMethod:CMH_HTTTP_METHOD_GET path:Healthy_365_Url parameters:subscript.dictionary];
