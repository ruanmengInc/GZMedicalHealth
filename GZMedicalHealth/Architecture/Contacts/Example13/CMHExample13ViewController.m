...
- (void)_deleteOperation{
    ...
    if (ids.count == 0) {
        ...
        [MBProgressHUD SG_showMBProgressHUDWithOnlyMessage:@"敢不敢选中一条数据" delayTime:1.0];
        return;
    }
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [MBProgressHUD SG_showMBProgressHUDWithOnlyMessage:@"Delete Success" delayTime:1.0];
