...
- (void)_setupNavigationItem{
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem mh_customItemWithTitle:@"取消" selectTitle:nil titleColor:CMH_MAIN_TINTCOLOR titleFont:MHRegularFont_16 imageName:nil target:self selector:@selector(_closeAction) contentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter];
